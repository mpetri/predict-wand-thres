    ...
    with open(query_file) as fp:
        ...
        for line in tqdm(lines, desc="read qrys", unit="qrys"):
            ...
            if len(new_query.term_ids) <= hyperparams.default_max_qry_len:
                ...
                new_query.wand_thres_10 = qry_dict["wand_thres_10"]
                new_query.wand_thres_100 = qry_dict["wand_thres_100"]
                new_query.wand_thres_1000 = qry_dict["wand_thres_1000"]
                for t in qry_dict["term_data"]:
                    new_term = Term()
                    new_term.id = t["id"]
                    new_term.q_weight = t["q_weight"]
                    new_term.Ft = t["Ft"]
                    new_term.mean_ft = t["mean_ft"]
                    new_term.med_ft = t["med_ft"]
                    new_term.min_ft = t["min_ft"]
                    new_term.max_ft = t["max_ft"]
                    new_term.mean_doclen = t["mean_doclen"]
                    new_term.med_doclen = t["med_doclen"]
                    new_term.min_doclen = t["min_doclen"]
                    new_term.max_doclen = t["max_doclen"]

                    new_term.num_ft_geq_256 = t["num_ft_geq_256"]
                    new_term.num_ft_geq_128 = t["num_ft_geq_128"]
                    new_term.num_ft_geq_64 = t["num_ft_geq_64"]
                    new_term.num_ft_geq_32 = t["num_ft_geq_32"]
                    new_term.num_ft_geq_16 = t["num_ft_geq_16"]
                    new_term.num_ft_geq_8 = t["num_ft_geq_8"]
                    new_term.num_ft_geq_4 = t["num_ft_geq_4"]
                    new_term.num_ft_geq_2 = t["num_ft_geq_2"]

                    new_term.block_score_1 = t["block_score_1"]
                    new_term.block_score_2 = t["block_score_2"]
                    new_term.block_score_4 = t["block_score_4"]
                    new_term.block_score_8 = t["block_score_8"]
                    new_term.block_score_16 = t["block_score_16"]
                    new_term.block_score_32 = t["block_score_32"]
                    new_term.block_score_64 = t["block_score_64"]
                    new_term.block_score_128 = t["block_score_128"]
                    new_term.block_score_256 = t["block_score_256"]
                    new_term.block_score_512 = t["block_score_512"]
                    new_term.block_score_1024 = t["block_score_1024"]
                    new_term.block_score_2048 = t["block_score_2048"]
